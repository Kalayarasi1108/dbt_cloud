INSERT INTO DATA_VAULT.CORE.LNK_STUDENT_UNIT_ENROLMENT_FEE (LNK_STUDENT_UNIT_ENROLMENT_FEE_KEY, HUB_UNIT_ENROLMENT_KEY,
                                                            HUB_STUDENT_UNIT_FEE_KEY, STU_ID, SPK_CD, SPK_VER_NO,
                                                            AVAIL_YR, LOCATION_CD, SPRD_CD, AVAIL_KEY_NO, SSP_NO,
                                                            PARENT_SSP_NO, EP_YEAR, EP_NO, FEE_SEQ_NO, SOURCE, LOAD_DTS,
                                                            ETL_JOB_ID)
SELECT MD5(IFNULL(UN_SSP.STU_ID, '') || ',' ||
           ...
           )                                     LNK_STUDENT_UNIT_ENROLMENT_FEE_KEY,
...
WHERE UN_SSP.SSP_NO <> UN_SSP.PARENT_SSP_NO
  AND NOT EXISTS(
        SELECT NULL
        FROM DATA_VAULT.CORE.LNK_STUDENT_UNIT_ENROLMENT_FEE L
