...
SELECT DATA_VAULT.CORE.SEQ.NEXTVAL               SAT_COURSE_ADMISSION_SANCTION_SK,
       s.HUB_COURSE_ADMISSION_SANCTION_KEY,
       'AMIS'                                    SOURCE,
...
FROM (SELECT HUB_COURSE_ADMISSION_SANCTION_KEY,
      ...
      FROM DATA_VAULT.CORE.SAT_COURSE_ADMISSION_SANCTION
     ) S
WHERE S.EFFECTIVE_END_DTS IS NULL
  ...
  AND NOT EXISTS(
        ...
        WHERE S.HUB_COURSE_ADMISSION_SANCTION_KEY = MD5(IFNULL(SCT_DTL.STU_ID, '') || ',' ||
