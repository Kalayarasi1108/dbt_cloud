-- DELETE
INSERT INTO DATA_VAULT.CORE.SAT_STUDYLINK_APPLICATION_COURSE (
                                                SAT_STUDYLINK_APPLICATION_COURSE_SK,
...
FROM (
         SELECT SAT.HUB_STUDYLINK_APPLICATION_COURSE_KEY,
                ...
                IS_DELETED
         FROM DATA_VAULT.CORE.SAT_STUDYLINK_APPLICATION_COURSE SAT
...
WHERE S.EFFECTIVE_END_DTS IS NULL
  ...
  AND NOT EXISTS(
        ...
        WHERE V.DF_APPLICATIONDETAILS_APPLICATIONID = S.APPLICATIONID
          AND V.PREFERENCEFIELDS_CUSTOMCOURSECODE = S.COURSE_CODE
    )
;