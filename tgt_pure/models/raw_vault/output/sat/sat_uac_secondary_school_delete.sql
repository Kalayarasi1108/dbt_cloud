-- DELETE
INSERT INTO DATA_VAULT.CORE.SAT_UAC_SECONDARY_SCHOOL(SAT_UAC_SECONDARY_SCHOOL_SK, HUB_UAC_SECONDARY_SCHOOL_KEY, SOURCE,
                                                     LOAD_DTS, ETL_JOB_ID, HASH_MD5,
                                                     IS_DELETED)
...
WITH SAT_UAC_SCHOOL_LATEST AS (
    ...
    FROM DATA_VAULT.CORE.SAT_UAC_SECONDARY_SCHOOL SAT
)
