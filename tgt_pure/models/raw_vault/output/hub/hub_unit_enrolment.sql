insert into DATA_VAULT.CORE.HUB_UNIT_ENROLMENT (HUB_UNIT_ENROLMENT_KEY, STU_ID, SPK_CD, SPK_VER_NO, AVAIL_YR,
                                                LOCATION_CD, SPRD_CD, AVAIL_KEY_NO, SSP_NO, PARENT_SSP_NO, SOURCE,
                                                LOAD_DTS, ETL_JOB_ID)
...
AND NOT EXISTS (
    SELECT NULL
    FROM DATA_VAULT.CORE.HUB_UNIT_ENROLMENT H
    WHERE H.HUB_UNIT_ENROLMENT_KEY =
